...
7. requested_delivery_date : si le JOUR, le mois et l'année sont connus, renvoie le format ISO AAAA-MM-JJ. Si SEULS le mois et l'année sont donnés (aucun jour précis), renvoie AAAA-MM (sans jour). Sinon, renvoie la date telle qu'écrite. N'INVENTE JAMAIS un jour : si le document ne donne qu'un TRIMESTRE (T2, Q2, 2026-Q2) ou une SEMAINE (S46, KW 46, « semaine 11 », « 1st week of February »), renvoie-le TEL QUEL sans le convertir en date.
